...
<div class="container" style="border-radius:10px; height:500px; margin-top:50px;">
    ...
    <div class="row" style="border-width: 2px; border-style: solid; border-radius: 10px; box-shadow: 0px 1px 30px 1px #284d7a; background-color:#F7FFFF;">
         ...
         <div class="col-md-6"style=" height:403px; border-radius: 10px 0px 0px 10px;"><img src="https://ofa.iiti.ac.in/facrec_che_2023_july_02/images/IITIndorelogo.png" style="margin-top: 5%; margin-left: 20%;">
        </div>
         ...
         <br />
          ...
          <form action="forgot-password.php" method="POST" autocomplete="">
            ...
            <div class="inner-addon left-addon">
               ...
               <input type="email" name="email" placeholder="Please Enter Your Registered Email" required value="<?php echo $email ?>">
           </div>
            ...
            <div class="row">
               <div class="col-md-3">
                 <button type="submit" name="change-password" value="Submit" class="cancelbtn">Submit</button>
               </div>
               <div class="col-md-9">
                 <a href="https://ofa.iiti.ac.in/facrec_che_2023_july_02/faculty/login"><button type="button" class="loginbtn pull-right">Login Area</button></a>
               </div>
             </div>
