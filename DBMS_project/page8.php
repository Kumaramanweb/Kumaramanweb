   ...
   <div class="row">
          ...
          <div class="panel panel-info">
            <div class="panel-heading">Upload 5 Best Research Papers in a single PDF < 6MB 
             <a href="https://ofa.iiti.ac.in/facrec_che_2023_july_02/attach/711_Ma_Agarwal_1698348165/711_best_5_1714816469182647.docx" class="btn-sm btn-info " target="_blank">View Uploaded File </a>
              <br />
              <br />
...
<div class="col-md-2">
  <button id="submit" type="submit" name="submit8" value="Submit" class="btn btn-success pull-right">SAVE & NEXT</button>
