         ...
         <legend>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
             ...
             <a href='#' class='btn btn-sm btn-info pull-right' onclick="<?php echo $fetch_info['name'] ?>" data-target='#passModal' data-toggle='modal'>Change Password</a>
...
<div class="row">
  <div class="col-md-12">
      ...
      <div class="col-md-4">
      <input id="doa" name="doa" type="text" value=" " placeholder="" class="form-control input-md" required="">
     </div>

      <label class="col-md-2 control-label" for="ref_num">Application Number</label>  
      <div class="col-md-4">

      <input id="ref_num" name="ref_num" type="text"  value="" placeholder="" class="form-control input-md" required="">
     </div>
...
<!-- <h5><font color="#025198"><strong>1. Name:</strong></font></h5>             -->
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="panel-heading">1. Personal Details <small class="pull-right" name="photo">Upload/Update Photo *</small></div>
              ...
              <div class="col-md-10">
                <div class="row">
                  ...
                  <span class="col-md-2 control-label" for="fname">First Name *</span>  
                    <div class="col-md-4">
                    <input id="fname" value="Trace" name="fname" type="text" placeholder="First name" class="form-control input-md" maxlength="15" required="">
                  </div>
                

                  <span class="col-md-2 control-label" for="mname">Middle Name</span>  
                    <div class="col-md-4">
                    <input id="mname" value="Danyka Danie" name="mname" name="mname" type="text" placeholder="Middle name" class="form-control input-md" maxlength="12">
                    </div>

                  <span class="col-md-2 control-label" for="lname">Last Name *</span>  
                    <div class="col-md-4">
                    <input id="lname" value="McGlynn" name="lname"name="lname" type="text" placeholder="Last name" class="form-control input-md" maxlength="15" required="">
                    </div>
                 ...
                 <!--  <span class="col-md-2 control-label" for="nationality">Nationality </span>  
                  ...
                  <span class="col-md-2 control-label" name="dob" for="dob">Date of Birth DD/MM/YYYY *</span>  
                  <div class="col-md-4">
                   <!--  <p id="dobdiv"> -->
                ...
                <!-- </p> -->
                  ...
                  <input type="hidden" name="Date" id="Date" value ="3" />
                  <!-- <br/> 
                 ...
                 <!--  <span class="col-md-2 control-label" for="age">Age</span>  
                  ...
                  <span class="col-md-2 control-label" name="gender" for="gender">Gender *</span>
                  <div class="col-md-4"> 
                  ...
                  <span class="col-md-2 control-label" name="mstatus" for="mstatus">Marital Status *</span>
                  <div class="col-md-4"> 
                ...
                <div class="row">
                  ...
                  <div class="col-md-4"> 
                      ...
                      <select id="id_proof" name="idproof" class="form-control input-md" required="">
                      <option value="">Select</option>
                       <!-- <option value="">Select</option> -->
                    ...
                    <div class="col-md-2"> 
                         <a class="btn btn-sm btn-success" target="_blank">View Uploaded File </a>
                    </div>
                     <div class="col-md-2"> 
                     <!-- <?php
                    ...
                    ?> -->
                      ...
                      <img src="uploads/id_proof/<?php echo $row['file']?>" class="thumbnail pull-right" />
          
                       <input id="id_card_file" name="id_proof" type="file" class="form-control input-md">
                    </div>
                     
                    
                    <span class="col-md-2 control-label" name="fathersname" for="fathersname">Father's Name *</span>  
                      <div class="col-md-4">
                      <input id="father_name" value="Timmothy_Hilpert77" name="father_name" name="fathersname" type="text" placeholder="Father's Name" class="form-control input-md" maxlength="30" required="">
                      </div>
                  </div>
            </div>
        ...
        <div class="col-md-2 pull-right">
            ...
            ?> -->
                      <img src="uploads/photos/<?php echo $row['file']?>" class="thumbnail pull-right" height="150" width="130" />
...
<div class="panel-body">
    <div class="row">
      <div class="col-md-6">
        <span class="control-label" name="cadd" for="cadd">Correspondence Address </span>
        <br />
        <br />
      ...
      <div class="col-md-6">
        <span class="control-label" name="padd" for="padd">Permanent Address </span>
        <br />
        <br />
...
<div class="panel-body">
  ...
  <div class="col-md-4">
  <input id="mobile" value="Customer Markets Con" name="mobile" type="text" placeholder="Mobile" class="form-control input-md" required="" maxlength="20">
  </div>
  ...
  <div class="col-md-4">
  <input id="email" name="email" type="text" placeholder="email" readonly='readonly' value="<?php echo $email; ?>" class="form-control input-md" required value="<?php echo $fetch_info['email'] ?>">
  </div>

  <span class="col-md-2 control-label" for="mobile_2">Alternate Mobile </span>  
  <div class="col-md-4">
  <input id="mobile_2" value="Legacy Accounts Deve" name="amobile" type="text" placeholder="Alternate Mobile " class="form-control input-md" maxlength="20">
  </div>

  <span class="col-md-2 control-label" for="email_2">Alternate Email </span>  
  <div class="col-md-4">
  <input id="email_2" value="your.email+fakedata28441@gmail.com" name="aemail" type="email" placeholder="Alternate Email" class="form-control input-md">
  </div> 
  
 
  <span class="col-md-2 control-label" for="landlinenum">Landline Number</span>  
  <div class="col-md-4">
  <input id="landline" value="45" name="landlinenum" type="text" placeholder="Landline Number" class="form-control input-md" maxlength="20">
  </div> 
...
<div class="col-md-12">
<button  id="submit" type="submit" name="submit1" value="Submit" class="btn btn-success pull-right">SAVE & NEXT</button>
</div>
...
<div class="modal-content">
    ...
    <div class="modal-body">
        <h3>Change Password For : <font color="#3377a0"><strong id="username_mod"> <?php echo $fetch_info['name'] ?></strong></font></h3>
    ...
    <div class="modal-footer">
        <button type="submit" name="changesubmit" value="Submit" class="btn btn-info" >Submit</button>
